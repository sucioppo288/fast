...
<body>
	...
	<center>
	<form id="gambar">
		<a href="kursuss.php"><img src="kursus.png" id="kursus" title="kursus" style="margin-right: 45px;" ></a>
		...
		<a href="feedback1.php"><img src="feedback.png" id="feedback" title="feedback" style="margin-right: 45px;"></a>
